...
if (buyPopup) { var buyClose = buyPopup.querySelector(".modal-close"); for (index = 0; index < buyButton.length; index++) button = buyButton[index], button.addEventListener("click", function(e) { buyPopup.classList.add("modal-show"), e.preventDefault() });
    buyClose.addEventListener("click", function(e) { e.preventDefault(), buyPopup.classList.remove("modal-show") }), window.addEventListener("keydown", function(e) { 27 === e.keyCode && (e.preventDefault(), buyPopup.classList.contains("modal-show") && buyPopup.classList.remove("modal-show")) }) }